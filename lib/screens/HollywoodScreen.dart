...
class HollywoodScreen extends StatelessWidget {
  const HollywoodScreen({Key? key, required this.x}) : super(key: key);
  final String x;
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Container(
          child: StreamBuilder(
            stream:
                FirebaseFirestore.instance.collection("Hollywood").snapshots(),
