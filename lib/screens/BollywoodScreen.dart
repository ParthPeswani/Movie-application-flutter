...
class BollywoodScreen extends StatelessWidget {
  const BollywoodScreen({Key? key, required this.x}) : super(key: key);
  final String x;
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Container(
          child: StreamBuilder(
            stream:
                FirebaseFirestore.instance.collection("Bollywood").snapshots(),
              ...
              if (snapshot != null && snapshot.data != null) {
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String movielink = snapshot.data!.docs[index]['movielink'];
